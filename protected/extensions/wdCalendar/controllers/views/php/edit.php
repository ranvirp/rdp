...
if(array_key_exists('id',$get)){
  $event = getCalendarByRange($get["id"]);
}
...
$cs = Yii::app()->clientScript;
		...
		$pathsrc=$am->publish($assetsPath."../../../src");
...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="<?php echo $path;?>/main.css" rel="stylesheet" type="text/css" />       
    <link href="<?php echo $path;?>/dp.css" rel="stylesheet" />    
    <link href="<?php echo $path;?>/dropdown.css" rel="stylesheet" />    
    <link href="<?php echo $path;?>/colorselect.css" rel="stylesheet" />   
     
    <script src="<?php echo $pathsrc;?>/jquery.js" type="text/javascript"></script>    
    <script src="<?php echo $pathsrc;?>/Plugins/Common.js" type="text/javascript"></script>        
    <script src="<?php echo $pathsrc;?>/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="<?php echo $pathsrc;?>/Plugins/jquery.validate.js" type="text/javascript"></script>     
    <script src="<?php echo $pathsrc;?>/Plugins/datepicker_lang_US.js" type="text/javascript"></script>        
    <script src="<?php echo $pathsrc;?>/Plugins/jquery.datepicker.js" type="text/javascript"></script>     
    <script src="<?php echo $pathsrc;?>/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
    <script src="<?php echo $pathsrc;?>/Plugins/jquery.colorselect.js" type="text/javascript"></script>    
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            //debugger;
            var DATA_FEED_URL = "<?php echo Yii::app()->createUrl("wdcal/df");?>";
            var arrT = [];
            var tt = "{0}:{1}";
            for (var i = 0; i < 24; i++) {
    ...
    .calpick     {        
        ...
        border:none;        
        cursor:pointer;        
        background:url("<?php echo $path;?>/images/icons/cal.gif") no-repeat center 2px;        
        margin-left:-22px;    
    }      
    </style>
  </head>
  <body>    
    <div>      
      ...
      <div class="infocontainer">            
        <form action="<?php echo Yii::app()->createUrl("wdcal/df");?>?method=adddetails<?php echo isset($event)?"&id=".$event->id:""; ?>" class="fform" id="fmEdit" method="post">                 
          <label>                    
            <span>                        *Subject:              
            </span>                    
            <div id="calendarcolor">
            </div>
            <input MaxLength="200" class="required safe" id="Subject" name="Subject" style="width:85%;" type="text" value="<?php echo isset($event)?$event->title:"" ?>" />                     
